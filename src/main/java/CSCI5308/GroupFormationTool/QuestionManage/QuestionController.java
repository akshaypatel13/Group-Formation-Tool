...
public class QuestionController {
    ...
    public static final List<String> questionTypes = Collections.unmodifiableList(Arrays.asList("Numeric", "Multiple Choice, Choose One", "Multiple choice, Choose Multiple", "Free text"));
