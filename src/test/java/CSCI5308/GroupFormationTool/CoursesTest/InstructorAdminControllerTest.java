...
public class InstructorAdminControllerTest {
    ...
    public void instructorAdminTest() throws Exception{
        this.mockMvc.perform(get("/course/instructoradmin")
                .param("id","121")
                .with(csrf())
                .with(
                        user("B-009911")
                ...
                .andDo(print())
                .andExpect(model().attributeExists("course","displayresults"))
                .andExpect(status().isOk());
    }

    @Test
    public void instructorAdminResultsTest() throws Exception{
        this.mockMvc.perform(get("/course/instructoradminresults")
                .param("id","121")
                .param("displayresults","true")
                .with(csrf())
                .with(
                        user("B-009911")
                                .password("Abcd@11")
    ...
    public void enrollTA() throws Exception{
        this.mockMvc.perform(get("/course/enrollta")
                .param("id","121")
                .param("displayresults","true")
                .with(csrf())
                .with(
